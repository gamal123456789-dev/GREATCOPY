...
const Sidebar: React.FC<SidebarProps> = ({ activePage, setActivePage }) => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-slate-900 via-gray-900 to-slate-900 border-r border-gray-700 shadow-2xl z-40">
      <div className="p-6">
          ...
          {menuItems.map((item) => (
            ...
            >
              <span className={`transition-colors duration-200 ${
                activePage === item.name ? 'text-white' : 'text-gray-400'
              }`}>
                {item.icon}
              </span>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-700">
        <div className="flex items-center gap-3 text-gray-400 text-sm">
          ...
          <div>
            ...
            <p className="text-xs">All services running</p>
          </div>
        </div>
      </div>
    </div>
